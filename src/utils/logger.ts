...
export default class Logging {
    ...
    static banner = (args: string )=> {
        console.log(chalk.green(`[${new Date().toLocaleString()}] [banner] `), 
    ...
    static debug = (args: string ) => {
        console.log(chalk.white(`[${new Date().toLocaleString()}] [debug] `), 
    ...
    static performance = (args: string ) => {
        console.log(chalk.cyan(`[${new Date().toLocaleString()}] [performance] `), 
                    typeof args === 'string' ? chalk.cyanBright(args) : args);
    }
    static log = (message: string , logCategory: string | undefined = undefined ) => {
        switch(logCategory){
            case 'banner':
                this.banner(message);
                break;
